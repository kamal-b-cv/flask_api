""" 
In this sample, the Flask app object is contained within the flask_app *module*;
that is, flask_app contains an __init__.py along with relative imports. Because
